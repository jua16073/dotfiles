...
# Replacing colors
sed -i -e 's/bg = .*/bg = #77414345/g' $PDIR/colors.ini
sed -i -e 's/fg = .*/fg = #CCDADA/g' $PDIR/colors.ini
sed -i -e 's/ac = .*/ac = #55FFFF/g' $PDIR/colors.ini
sed -i -e 's/bi = .*/bi = #dc344148/g' $PDIR/colors.ini
sed -i -e 's/be = .*/be = #dc344148/g' $PDIR/colors.ini
sed -i -e 's/mb = .*/mb = #001013/g' $PDIR/colors.ini
sed -i -e 's/mgf = .*/mgf = #55CFAA/g' $PDIR/colors.ini
sed -i -e 's/mf = .*/mf = #55FFDD/g' $PDIR/colors.ini
# Restarting polybar
$LAUNCH1 &
$LAUNCH2 &
##77CCCC
